var map;
//        var server = "http://205.251.137.35/angkotbukittinggi/";
        var server = "http://localhost/_ta2_upload/";
        ...
        {
          $('#tombol').empty();
          $('#tombol').append('<a type="button" id="hidelegenda" onclick="hideLegenda()" class="btn btn-default " data-toggle="tooltip" title="Sembunyikan Legenda" style="margin-right: 5px;"><i class="fa fa-eye-slash style="margin-right: 5px; "></i></a> ');
          ...
          var layer = new google.maps.FusionTablesLayer(
            ...
            var legend = document.createElement('div');
                ...
                content.push('<p><div class="color a"></div>District of Mandianngin Koto Selayan</p>');
        ...
        function hideLegenda() {
          ...
          $('#tombol').empty();
          console.log("Success");
          $('#tombol').append('<a type="button" id="showlegenda" onclick="legenda()" class="btn btn-default " data-toggle="tooltip" title="Legenda" style="margin-right: 5px; "><i class="fa fa-eye" > </i></a>');
        }
