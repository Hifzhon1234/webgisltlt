var map;
        var server = "https://hifzhonalnutari-3005-webgislt.herokuapp.com/";
          ...
          $.ajax({url: server+'_data_angkot_cari.php?tipe='+tipe+'&nilai='+y, data: "", dataType: 'json', success: function(rows){ 
            if(rows == null)
            {
              ...
              for (var i in rows){ 
                ...
                var color = row.color;
                var route_color = row.route_color;
                $('#kanan_table').append("<tr><td>"+track+"</td><td><a role='button' class='btn btn-success fa fa-info' title='info' onclick='data_angkot_1_rute(\""+id+"\")'></a>&nbsp<a role='button' class='btn btn-success fa fa-taxi' title='Local Transportation' onclick='data_angkot_2_rute(\""+id+"\")'></a></td></tr>");  
      ...
      function td_hotel_angkot(id_angkot){ // HOTEL SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_hotel.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            markersDua.push(marker);
            map.setCenter(centerBaru);
            $('#table_kanan_hotel').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' style='margin-right:5px' onclick='listgeom_hotel(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='Detail' style='margin-right:5px' onclick='modal_hotel(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='Local Transportation' style='margin-right:5px' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td><td><a role='button' class='btn btn-success fa fa-road' title='Route From Object' onclick='route_angkot(\""+lat2+"\",\""+lng2+"\",\""+lat+"\",\""+lng+"\",\""+id_angkot+"\",\""+id+"\")'></a></td></tr>");
          }//end for
        }});//end ajax  
      }
      ...
      function td_masjid_angkot(id_angkot){ // MASJID SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_worship_place.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_worship').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' style='margin-right:5px' onclick='listgeom_worship(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='Detail' style='margin-right:5px' onclick='modal_masjid(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='Local Transportation' style='margin-right:5px' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td><td><a role='button' class='btn btn-success fa fa-road' title='Route From Object' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
      }
      ...
      function td_oo_Angkot(id_angkot){ // OLEH-OLEH SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_souvenir.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_souvenir').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' style='margin-right:5px' onclick='listgeom_oo(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='Detail' style='margin-right:5px' onclick='modal_oo(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='Local Transportation' style='margin-right:5px' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td><td><a role='button' class='btn btn-success fa fa-road' title='Route From Object' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
      }
       ...
       function td_tw_angkot(id_angkot){ // OLEH-OLEH SEKITAR ANGKOT
        ...
        $.ajax({url: server+'/_angkot_tourism.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_tourism').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' style='margin-right:5px' onclick='listgeom_tourism(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='Detail' style='margin-right:5px' onclick='modal_tw(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='Local Transportation' style='margin-right:5px' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td><td><a role='button' class='btn btn-success fa fa-road' title='Route From Object' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
      }
      ...
      // TEMPAT WISATA SEKITAR ANGKOT
        ...
        $.ajax({url: server+'_angkot_restaurant.php?id_angkot='+id_angkot, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
              ...
              $('#table_kanan_restaurant').append("<tr><td>"+name+"</td><td><a role='button' class='btn btn-success fa fa-map-marker' title='position' style='margin-right:5px' onclick='listgeom_restaurant(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-info' title='Detail' style='margin-right:5px' onclick='modal_restaurant(\""+id+"\")'></a></td><td><a role='button' class='btn btn-success fa fa-taxi' title='Local Transportation' style='margin-right:5px' onclick='data_angkot_2_rute(\""+id_angkot+"\")' title='Route'></a></td><td><a role='button' class='btn btn-success fa fa-road' title='Route From Object' onclick='route_angkot(\""+lat2+"\",\""+lon2+"\",\""+lat+"\",\""+lon+"\",\""+id_angkot+"\",\""+id+"\")'></a></td></tr>");
            }//end for
        }});//end ajax  
      }
...
//              var isi = row[i];
            ...
            console.log(rute);
            console.log(fungsi);
            $('#view_tracking_table').append("<tr><td>"+rute+"</td><td><a role='button' class='btn btn-success fa fa-taxi' title='Local Transportation' onclick=\"hapus_kecuali_landmark();"+fungsi+"\"></a></td></tr>");
      ...
      function legenda()
{
  ...
  var layer = new google.maps.FusionTablesLayer(
    ...
    var legend = document.createElement('div');
        legend.id = 'legend';
        var content = [];
        content.push('<h4 style="color:black;">Legend</h4>');
            content.push('<font style="color:black;"><div class="color b"></div>Mandiangin Koto Selayan</font><br>');
            content.push('<font style="color:black;"><div class="color c"></div>Guguak Panjang</font><br>');
            content.push('<font style="color:black;"><div class="color e"></div>Aur Biru Tigo Baleh</font>');
      ...
      function industri_sekitar(latitude,longitude,rad){ // INDUSTRI SEKITAR
        ...
        $.ajax({url: server+'_sekitar_small_industry.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
          for (var i in rows){ 
            ...
            markersDua.push(marker);
            map.setCenter(centerBaru);
            $('#view_industri_table').append("<tr><td>"+name+"</td><td><a role='button' style='margin-right:10px' class='btn btn-danger fa fa-taxi' title='Local Transportation' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin-right:10px' class='btn btn-success fa fa-info' title='info' onclick='modal_industri(\""+id+"\")'></a><a role='button' class='btn btn-success fa fa-map-marker' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td></tr>");
          }//end for
        }});//end ajax  
      }
      ...
      function oleholeh_sekitar(latitude,longitude,rad){ // OLEH-OLEH SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_oleholeh.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#view_oo_table').append("<tr><td>"+name+"</td><td><a role='button' style='margin-right:10px' class='btn btn-danger fa fa-taxi' title='Route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin-right:10px' class='btn btn-success fa fa-info' title='info' onclick='modal_oo(\""+id+"\") '></a><a role='button' class='btn btn-success fa fa-map-marker' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
      ...
      function tw_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_tourism.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#view_tw_table').append("<tr><td>"+name+"</td><td><a role='button' style='margin-right:10px' class='btn btn-danger fa fa-taxi' title='Route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin-right:10px' class='btn btn-success fa fa-info' title='info' onclick='modal_tw(\""+id+"\")'></a><a role='button' class='btn btn-success fa fa-map-marker' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
      ...
      function h_sekitar(latitude,longitude,rad){ // TEMPAT WISATA SEKITAR ANGKOT
          ...
          $.ajax({url: server+'_sekitar_hotel.php?lat='+latitude+'&long='+longitude+'&rad='+rad, data: "", dataType: 'json', success: function(rows){ 
            for (var i in rows){ 
              ...
              $('#view_hotel_table').append("<tr><td>"+name+"</td><td><a role='button' style='margin-right:10px' class='btn btn-danger fa fa-taxi' title='Route' onclick='route_sekitar(\""+latitude+"\",\""+longitude+"\",\""+lat+"\",\""+lon+"\")'></a><a role='button' style='margin-right:10px' class='btn btn-success fa fa-info' title='info' onclick='modal_hotel(\""+id+"\")'></a><a role='button' class='btn btn-success fa fa-map-marker' onclick='set_center(\""+lat+"\",\""+lon+"\",\""+name+"\")'></a></td></tr>");
            }//end for
          }});//end ajax  
        }
